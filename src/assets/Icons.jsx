...
const ActiveNotificationsIcon = ({ size }) => {
  return (
    <svg
      aria-label="Notifications"
      height={size}
...
const Icons = ({ name, size = 24 }) => {
  const icons = {
    ...
    instagramText: InstagramTextIcon,
    home: HomeIcon,
    homeActive: ActiveHomeIcon,
    search: SearchIcon,
    searchActive: ActiveSearchIcon,
    explore: ExploreIcon,
    exploreActive: ActiveExploreIcon,
    messages: MessagesIcon,
    messagesActive: ActiveMessagesIcon,
    notifications: NotificationsIcon,
    notificationsActive: ActiveNotificationsIcon,
    create: CreateIcon,
    createActive: ActiveCreateIcon,
    menu: MenuIcon,
